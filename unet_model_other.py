...
from helpers import load_all_images, prepare_train, prepare_test, printProgressBar
import json
from unet_model import unet_pixel
...
class Model:
    def __init__(self) -> None:
        ...
        self.model_path = "models/unet_pixel/"
    ...
    def prepare_test(self, all_images):
        return prepare_train(all_images)

    def rebuild_output(self, predictions):
        return predictions.mul(255).to(torch.uint8).numpy()
